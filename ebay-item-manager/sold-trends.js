...
class SoldItemsTrends {
    ...
    addSubcategoryItemEditorRow(item = {}) {
        ...
        const photoHtml = photoUrl 
            ...
            : `<div class="subcategory-item-photo" style="display: none;"><img src="" alt="${safeLabel || 'Item photo'}" onerror="this.style.display='none'; this.parentElement.querySelector('.subcategory-item-photo-placeholder').style.display='flex';"></div><div class="subcategory-item-photo-placeholder"><span>📷</span></div>`;
