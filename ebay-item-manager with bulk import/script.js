...
class EbayListingLife {
    ...
    async loadData() {
        ...
        // If no data in localStorage, try loading from backend (even in local mode if server is running)
        if (!savedData && backendAvailable) {
            try {
                console.log(`No data in localStorage, trying to load from backend storage server...`);
