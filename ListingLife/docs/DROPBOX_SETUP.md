...
5. **IMPORTANT: Enable Required Permissions**
   ...
   - Under **"Files and folders"**, make sure **BOTH** of these are enabled:
     - **"files.content.read"** (required to load data from Dropbox)
     - **"files.content.write"** (required to save data to Dropbox)
   - **YOU MUST ENABLE BOTH** - the app needs both scopes to work correctly!
...
### "files.content.read scope required" or "files.content.write scope required" or "not permitted to access this endpoint"
**This is the most common error!** Your Dropbox app is missing required permissions. **YOU NEED BOTH SCOPES:**
1. Go to https://www.dropbox.com/developers/apps
2. Click on your app (ID: 5394387 or your app ID)
3. Go to the **"Permissions"** tab
4. Under **"Files and folders"**, find and **enable BOTH**:
   - **"files.content.read"** (required to load/download data)
   - **"files.content.write"** (required to save/upload data)
5. **BOTH MUST BE ENABLED** - check both boxes!
6. **Regenerate your access token** (go back to "Settings" → "OAuth 2" → "Generate" new token)
7. **Copy the new token** - this is important because old tokens don't have the new scopes
8. **Update your access token** in the app settings
